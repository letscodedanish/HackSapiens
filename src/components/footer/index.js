            ...
            <div id="footer">
                ...
                <div className="copy-right">
                    <div className="icons-container">
                        <a href="https://github.com/letscodedanish/Hack-It-Sapiens.git" target="_blank" rel="noreferrer">
                    ...
                    <div className="cr">
                        <Text> &copy; Copyright <strong><span>Sehat Sathi</span></strong>. All Rights Reserved</Text>
                    </div>
                </div>
