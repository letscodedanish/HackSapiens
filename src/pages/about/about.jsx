...
export default function About() {
    const list = [
        {
            title: "Sehat Sathi is a decentralised system for sharing electronic medical records (EMR). You have total control over your data thanks to its fundamental technology, which is based on the Ethereum network and IPFS. Your records are only accessible to authorised parties and registered medical institutions.",
            img: "docmed.png",
        ...
        <div style={{ marginTop: "1rem" }}>
            ...
            <div>
                ...
                <h5 style={{
                    ...
                    Sehat Sathi is a decentralized solution for Electronic Medical Records (EMR) sharing systems.
                    ...
                    Sehat Sathi solves this problem by providing a decentralized platform where medical records can be securely stored and easily shared among authorized parties.
                </h5>
                <Box css={{
                ...
                <div>
                    ...
                    <h5 style={{
                        ...
                        backdropFilter: "blur(4.6px)",
                        webkitBackdropFilter: "blur(4.6px)",
                    }}>A decentralised, user-friendly electronic medical record system is offered by Sehat Sathi.
                        ...
                        Sehat Sathi offers a powerful solution for EMR systems by providing a secure and efficient way of sharing medical records and enabling patients to have more control over their own data.
                        ...
                        <Card css={{ p: "$6", mw: "400px" }}>
                            ...
                            <Card.Body css={{ py: "$2" }}>
                                <Text>
                                    ...
                                    Sehat Sathi is a system that is free to use and nonprofit. This software is not required to be purchased. It is accessible to all.
